...
export default async function ParentPage({
  ...
  const selected = (students as Student[]).find(student => student.id === searchParams.student) || (students as Student[])[0];
        ...
        <section className="stack">
          {selected ? (
            <>
              ...
              <AvailabilityPicker ownerType="student" ownerId={selected.id} initialSlots={slots as AvailabilitySlot[]} />
            </>
          ) : (
